...
Tidy tools are easy to understand and easy to use. If tidy data is the data format optimised for R, tidy tools are the function format optimised for _you_. 

```{block2, type = "rmdtip"}
If you'd like to develop a deeper understanding of the tidyverse, I encourage you to read [_R for Data Science_](https://r4ds.had.co.nz/), or to work through the [free primers on RStudio Cloud](https://rstudio.cloud/learn/primers).
```