...
Inside `View()` you insert a R object and then the title for the data viewer. This is really unnecessary with a few datasets, but when inspecting numerous datasets, this comes in handy. 
