...
If a function comes in an R package, you will need to load the package with `library()` before you can access the function's help page. Alternatively, you can access the help page by typing a `?` followed by the package name, followed by `::`, followed by the function name, e.g.
