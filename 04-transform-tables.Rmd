...
starwars %>% 
  mutate(birth_year = case_when(
    between(birth_year, 0, 50) ~ "young",
    between(birth_year, 51, 400) ~ "middle-aged",
    between(birth_year, 401, 900) ~ "old",
    TRUE ~ "NA Age"
  ))
```
...
Here is a more complicated example from dplyr [docs](https://dplyr.tidyverse.org/reference/case_when.html)
