...
You want to use `tidyverse` expressions to manipulate a dataset and then assign the resulting dataset back to its original object. 

You don't want to repeat the name of the object twice. For example:
...
The authors of the renown [R for Data Science](https://r4ds.had.co.nz/) present a contrary opinion to the  compound assignment operator. 
...
What this boils down to whether you prefer writing concise code (`%<>%`) or readable and clear code (repeating the name of the object twice with `%>%`).
